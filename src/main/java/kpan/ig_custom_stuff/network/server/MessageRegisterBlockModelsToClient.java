...
public class MessageRegisterBlockModelsToClient extends MessageBase {
	...
	public MessageRegisterBlockModelsToClient(Map<BlockModelId, BlockModelEntryBase> modelId2Entry) {
