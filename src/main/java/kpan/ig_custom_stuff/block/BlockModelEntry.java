...
public class BlockModelEntry {
	...
	public void replaceTextureId(EnumFacing face, ResourceLocation textureId) {
		textureIds.put(face.getName2(), textureId);
	}

	public void replaceParticleTextureId(ResourceLocation textureId) {
		textureIds.put("particle", textureId);
	}
